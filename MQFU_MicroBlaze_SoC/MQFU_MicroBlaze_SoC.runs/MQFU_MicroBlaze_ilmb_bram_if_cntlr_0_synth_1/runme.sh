...
HD_PWD='C:/Dev/Madgwick_Quaternion_Filter_Unit/MQFU_MicroBlaze_SoC/MQFU_MicroBlaze_SoC.runs/MQFU_MicroBlaze_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MQFU_MicroBlaze_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MQFU_MicroBlaze_ilmb_bram_if_cntlr_0.tcl

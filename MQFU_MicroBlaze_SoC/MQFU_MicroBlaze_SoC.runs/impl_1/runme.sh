...
HD_PWD='C:/Dev/Madgwick_Quaternion_Filter_Unit/MQFU_MicroBlaze_SoC/MQFU_MicroBlaze_SoC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MQFU_MicroBlaze_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MQFU_MicroBlaze_wrapper.tcl -notrace

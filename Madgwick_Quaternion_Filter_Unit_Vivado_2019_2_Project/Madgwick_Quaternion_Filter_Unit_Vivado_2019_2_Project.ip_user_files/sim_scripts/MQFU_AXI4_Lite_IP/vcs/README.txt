...
#
# Generated by export_simulation on Fri Jan 03 10:53:21 +0000 2025
#
################################################################################
...
'-reset_run' switch to the './MQFU_AXI4_Lite_IP.sh' script.

./MQFU_AXI4_Lite_IP.sh -reset_run
...
./MQFU_AXI4_Lite_IP.sh -noclean_files

For more information on the script, please type './MQFU_AXI4_Lite_IP.sh -help'.
